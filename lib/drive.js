...
async function listFolders() {
  ...
  return listAll(api, '/drive/v3/files?q=' + q + '&fields=files(id,name)&pageSize=1000&orderBy=name', 'Liste des dossiers Drive impossible');
}
...
async function listSubfolders(folderId) {
  ...
  return listAll(api, '/drive/v3/files?q=' + q + '&fields=files(id,name)&pageSize=100&orderBy=name', 'Lecture des sous-dossiers impossible');
}
...
async function listImages(folderId) {
  ...
  return listAll(api, '/drive/v3/files?q=' + q + '&fields=files(id,name,mimeType,size,thumbnailLink,createdTime)&pageSize=1000&orderBy=name', 'Lecture du dossier Drive impossible');
}
...
async function listAllFiles(folderId) {
  ...
  return listAll(api, '/drive/v3/files?q=' + q + '&fields=files(id,name,mimeType,size)&pageSize=1000&orderBy=name', 'Lecture du dossier Drive impossible');
}
...
async function listUserFolders() {
  const q = encodeURIComponent("mimeType='application/vnd.google-apps.folder' and trashed=false");
  return listAll(userApi, '/drive/v3/files?q=' + q + '&fields=files(id,name)&pageSize=1000&orderBy=name', 'Liste des dossiers impossible');
}
