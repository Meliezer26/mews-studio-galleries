...
const ALBUM_LABELS = {
  ...
  'posters-30x45': 'Posters 30\u00d745',
  'agrandissements-20x30': 'Agrandissements 20\u00d730',
};
...
function selectionFolderName(gallery, selection) {
  ...
  const displayName = cleanName(
    (selection && selection.name) || gallery.eventName || gallery.clientName || gallery.name
  );
  return 'Sélection — ' + displayName + ' — ' +
...
module.exports = { isReady, enqueue, applySelection, selectionFolderName, setStatus, cleanupSelectionFolders, ALBUM_LABELS };
