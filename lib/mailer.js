...
function buildClientAccessContent(info) {
  ...
  lines.push('');
  lines.push('Pour accéder à votre galerie privée, veuillez cliquer sur le lien privé ci-dessous.');
  lines.push(gUrl);
  lines.push('');
  lines.push(mdpText);
  lines.push('');
  ...
  <p style="margin:0 0 18px;font-size:15px">Pour accéder à votre galerie privée, veuillez cliquer sur le lien privé ci-dessous.</p>
  ${btn}
